...
navigation:
  icon: i-lucide-image
seo:
  description: Ajoutez des images, vidéos et autres éléments HTML avec le thème Xinyi Class
  title: Images et intégrations
---
...
Xinyi Class utilisera le composant `<NuxtImg>` sous le capot à la place de la balise native `img`.
::
