...
Xinyi Class is a **Nuxt layer** that extends your standard Nuxt application with documentation features. This gives you the flexibility of a full Nuxt project.

When you create a new Xinyi Class project with `npx create-tockdocs my-docs`, you get:
...
This is where you write pages in Markdown. Xinyi Class automatically generates routes based on your file structure.
...
::tip
You can separate your documentation files within a `docs/` subfolder to make them accessible at the `/docs` route. Additionally, you have the flexibility to override your landing page using custom Vue pages if desired. Learn more in the [edition documentation](https://tockdocs.vercel.app/docs/manual/en/concepts/edition).
::
...
a Xinyi Class application is really minimal and looks like:
...
_This file is not mandatory to start a Xinyi Class application._
...
This is where you can configure Xinyi Class to fit your branding, handle SEO, set your locale, and adapt links and socials. See the [configuration documentation](https://tockdocs.vercel.app/docs/manual/en/concepts/configuration) for details.
...
Since Xinyi Class is a Nuxt layer, you can use **any feature** of a standard Nuxt project:
