    ...
    ui: group({
      ...
      fields: {
        ...
        pageHero: field({
          type: 'object',
          title: 'Page Hero',
          description: 'Nuxt UI page hero theme overrides.',
        ...
        pageCard: field({
          type: 'object',
          title: 'Page Card',
          description: 'Nuxt UI page card theme overrides.',
        ...
        contentToc: field({
          type: 'object',
          title: 'Content TOC',
          description: 'Nuxt UI content table of contents theme overrides.',
          icon: 'i-lucide-list',
          default: {},
        }),
      },
        ...
        logo: group({
          ...
          fields: {
            ...
            favicon: field({
              type: 'media',
              title: 'Favicon',
              description: 'Path to the favicon file used in the browser tab and brand asset downloads.',
