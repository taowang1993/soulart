...
**Xinyi Class and Nuxt UI** provides a set of styled and beautiful prose components to help you write your documentation using the [MDC syntax](https://content.nuxt.com/docs/files/markdown#mdc-syntax).
...
::tabs
  :::tabs-item{icon="i-lucide-eye" label="Preview"}
    ::::accordion
      ...
      label: What is Xinyi Class and what are its key features??
      ---
      Xinyi Class is a fully integrated documentation solution built with Nuxt UI. It's a theme based on the UI documentation template that provides a ready-to-use visual. User can focus on content using Markdown and MDC syntax.
      :::::

      :::::accordion-item
      ---
      icon: i-lucide-circle-help
      label: How do I get started with Xinyi Class?
      ---
      The only thing you need to start a Xinyi Class project is a `content/` folder. You can have a check at the starter for a quick start.
      :::::
  ...
  :::accordion-item{label="What is Xinyi Class and what are its key features??" icon="i-lucide-circle-help"}
  Xinyi Class is a fully integrated documentation solution built with Nuxt UI. It's a theme based on the UI documentation template that provides a ready-to-use visual. User can focus on content using Markdown and MDC syntax.
  :::

  :::accordion-item{label="How do I get started with Xinyi Class?" icon="i-lucide-circle-help"}
  The only thing you need to start a Xinyi Class project is a `content/` folder. You can have a check at the starter for a quick start.
  :::
...
::tabs
  :::tabs-item{.my-5 icon="i-lucide-eye" label="Preview"}
    ...
    ```bash [Terminal]
    npm create nuxt@latest -- -t github:taowang1993/soulart/.starters/default
    ```
