...
**Xinyi Class 和 Nuxt UI** 提供了一套样式美观的 prose 组件，帮助您使用 [MDC 语法](https://content.nuxt.com/docs/files/markdown#mdc-syntax)编写文档。
...
::tabs
  :::tabs-item{icon="i-lucide-eye" label="预览"}
    ::::accordion
      ...
      label: 什么是 Xinyi Class，它的主要功能是什么？
      ---
      Xinyi Class 是一个基于 Nuxt UI 构建的全集成文档解决方案。它是一个基于 UI 文档模板的主题，提供即用型视觉效果。用户可以专注于使用 Markdown 和 MDC 语法编写内容。
      :::::

      :::::accordion-item
      ---
      icon: i-lucide-circle-help
      label: 如何开始使用 Xinyi Class？
      ---
      开始 Xinyi Class 项目所需的只是一个 `content/` 文件夹。您可以查看起步模板以快速入门。
      :::::
  ...
  :::accordion-item{label="什么是 Xinyi Class，它的主要功能是什么？" icon="i-lucide-circle-help"}
  Xinyi Class 是一个基于 Nuxt UI 构建的全集成文档解决方案。它是一个基于 UI 文档模板的主题，提供即用型视觉效果。用户可以专注于使用 Markdown 和 MDC 语法编写内容。
  :::

  :::accordion-item{label="如何开始使用 Xinyi Class？" icon="i-lucide-circle-help"}
  开始 Xinyi Class 项目所需的只是一个 `content/` 文件夹。您可以查看起步模板以快速入门。
  :::
