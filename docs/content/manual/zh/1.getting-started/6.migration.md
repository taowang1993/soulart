---
title: 迁移
description: 如何将现有 Markdown 文档迁移到 Xinyi Class
navigation:
...
现代 Xinyi Class 使用 **Nuxt 层**和 **`create-tockdocs` 起步模板工作流**。
...
- **传统模式** — 用于单一文档树
- **知识库模式** — 用于需要多个知识库的场景，如 `/docs/manual/zh/...` 和 `/docs/chemistry/zh/...`
...
内容迁移完成后，请查阅[配置](/docs/manual/zh/concepts/configuration)、[助手](/docs/manual/zh/ai/assistant) 和 [MCP](/docs/manual/zh/ai/mcp) 指南，使您的应用与当前的 Xinyi Class 规范保持一致。
::
