---
title: 国际化
description: 使用 Xinyi Class 内置的 i18n 支持创建多语言文档。
navigation:
  icon: i-lucide-globe
seo:
  description: 学习如何使用 Xinyi Class 内置的 i18n 支持设置和管理多语言文档。
  title: 国际化
---

Xinyi Class 在其两种内容模式下均支持国际化：
...
::warning
Xinyi Class 强制文档路由策略为 `prefix`，以确保本地化文档路由保持明确。
::
...
如果某个文档语言缺失，Xinyi Class 会尽可能回退到知识库或站点的默认语言。
