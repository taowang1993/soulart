...
description: Create multi-language documentation with Xinyi Class built-in i18n support.
navigation:
  icon: i-lucide-globe
seo:
  description: Learn how to set up and manage multi-language documentation with Xinyi Class built-in i18n support.
  title: Internationalization
---

Xinyi Class supports internationalization in both of its content modes:
...
## What Xinyi Class handles for you
...
::warning
Xinyi Class forces the docs routing strategy to `prefix` so localized docs routes stay explicit.
::
...
Xinyi Class only registers docs locales that are backed by real content.
...
If a docs locale is missing, Xinyi Class falls back to the KB or site default locale when possible.
