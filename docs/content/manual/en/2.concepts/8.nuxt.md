...
## Xinyi Class is a Nuxt app

Xinyi Class is distributed as a **Nuxt layer**. When you scaffold a project, you get a normal Nuxt application that extends the layer and can use the standard Nuxt ecosystem.
...
Because Xinyi Class is a layer instead of a closed template, you can:
