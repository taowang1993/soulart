...
seo:
  description: Learn how to write your documentation with Xinyi Class and Nuxt Content.
  title: Edition
---

Xinyi Class is built on **Nuxt Content**. You write docs in Markdown, add richer UI with **MDC syntax**, and let the layer derive routing, navigation, search, and page metadata from your content structure.

## Content modes

Xinyi Class supports two routing/content architectures.
...
KB mode is enabled when Xinyi Class detects one or more `content/<kb>/kb.yml` files.
...
If no custom Vue landing page exists, Xinyi Class uses Markdown landing content:
...
- otherwise Xinyi Class falls back to a knowledge-base directory page

### Custom Vue landing page

Since Xinyi Class is a Nuxt layer, you can always replace the landing page with your own Vue page:
...
Common keys used by Xinyi Class pages:
...
Xinyi Class ignores numeric ordering prefixes when generating public URLs. For example:
...
## What Xinyi Class derives automatically

From your content tree, Xinyi Class automatically derives:
