---
title: Migration
description: " How to migrate your documentation from an existing Markdown solution to Xinyi Class"
navigation:
...
Modern Xinyi Class uses a **Nuxt layer** and the **`create-tockdocs` starter workflow**.
...
Whether you are coming from older TockDocs versions, the Nuxt UI docs template, or another Markdown site, the migration path is usually:

::steps
### Create a fresh Xinyi Class project
...
Once content is moved, review the [Configuration](/docs/manual/en/concepts/configuration), [Assistant](/docs/manual/en/ai/assistant), and [MCP](/docs/manual/en/ai/mcp) guides to align your app with current Xinyi Class conventions.
::
